...
async function initializeKeypair(
  ...
  async function transferSol(connection:Web3.Connection, payer: Web3.Keypair){
    ...
    const lamportsToSend = 100_000_000;
    ...
    console.log(`from ${payer.publicKey.toBase58()}, to ${toKeypair.publicKey}, this much: ${lamportsToSend / Web3.LAMPORTS_PER_SOL}`)
    const transactionSignature = await Web3.sendAndConfirmTransaction(connection, transferTransaction, [payer])
...
async function main() {
    ...
    await transferSol(connection, signer)
  }
